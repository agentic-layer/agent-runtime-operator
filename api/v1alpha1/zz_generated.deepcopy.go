...
func (in *AgentToolUpstream) DeepCopyInto(out *AgentToolUpstream) {
	*out = *in
	if in.ToolRouteRef != nil {
		in, out := &in.ToolRouteRef, &out.ToolRouteRef
		*out = new(v1.ObjectReference)
		**out = **in
	}
...
func (in *PresidioGuardConfig) DeepCopyInto(out *PresidioGuardConfig) {
	*out = *in
	...
	if in.EntityActions != nil {
		in, out := &in.EntityActions, &out.EntityActions
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
